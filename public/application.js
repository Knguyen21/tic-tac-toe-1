...
var clickCount = store.clickCount;

// add response if empty and add to board
var playGame = function playGame(element) {
  var player = clickCount % 2 === 0 ? 'x' : 'o';
  ...
  if (store.status === 'active') {
    if (empty) {
      ...
      element.html(player);
      var isWinner = checkForWinner(board, player);
...
var updateScore = function updateScore(player) {
  var element = '#player_' + player + '_score';
  // console.log($(element))
  var score = parseInt($(element).html());
  if (score === 'NAN') {
    score = 0;
  }
  // score += 1
...
var checkForWinner = function checkForWinner(board, player) {
  var val = player;
  // const winner = val
  if (board[0] === val && board[1] === val && board[2] === val || board[3] === val && board[4] === val && board[5] === val || board[6] === val && board[7] === val && board[8] === val || board[0] === val && board[3] === val && board[6] === val || board[1] === val && board[4] === val && board[7] === val || board[2] === val && board[5] === val && board[8] === val || board[0] === val && board[4] === val && board[8] === val || board[2] === val && board[4] === val && board[6] === val) {
    return true;
  } else {
    return false;
  }
